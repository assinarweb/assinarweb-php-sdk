...
use AssinarWeb\Service\EnvelopeService as EnvelopeService;
...
$envelope->setEnvelope('f7cedb5e5d14bc687bb6067acc6f1e99');
$envelope->setIdFiles([1, 2]);
dump(EnvelopeService::deleteFiles($apiContext, $envelope));